    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="space-y-4 rounded-lg">
            <div class="p-4 bg-white rounded-xl shadow-sm border border-gray-100 flex justify-between items-center">
                ...
                @include('components.modal.tambah-admin')
            </div>
                    ...
                    <tbody>
                        @foreach ($admins as $data)
                            <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                                <td class="px-6 py-4">{{ $admins->firstItem() + $loop->index }}</td>
                                ...
                                <td class="px-6 py-4 flex items-center gap-2">
                                    ...
                                    {{-- Modal Edit --}}
                                    @include('components.modal.edit-admin', ['data' => $data])
                                    {{-- End Edit --}}
            ...
            <div class="pt-2">
                {{ $admins->links('components.pagination.blue') }}
            </div>
        </div>
    </div>
