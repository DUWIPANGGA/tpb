        ...
        <div class="relative bg-white rounded-lg shadow-sm">
            ...
            <div class="p-4 md:p-5">
                <form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    @csrf
                    <div>
                        <label for="foto" class="block mb-2 text-sm font-medium text-gray-600">Foto
                            Barang</label>
                        <input type="file" name="foto" id="foto"
                            class="w-full px-4 text-sm text-gray-900 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent">
                    </div>
